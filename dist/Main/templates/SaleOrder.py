...
class SaleOrderPanel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText21 = wx.StaticText( self, wx.ID_ANY, u"Date of invoice: *", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText32 = wx.StaticText( self, wx.ID_ANY, u"Symbol/Order:", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		...
		self.m_staticText22 = wx.StaticText( self, wx.ID_ANY, u"Customer name:* ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText22.Wrap( -1 )
		gbSizer5.Add( self.m_staticText22, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_staticText23 = wx.StaticText( self, wx.ID_ANY, u"Address:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText24 = wx.StaticText( self, wx.ID_ANY, u"Contact phone:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText25 = wx.StaticText( self, wx.ID_ANY, u"Payment method:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText25.Wrap( -1 )
		gbSizer5.Add( self.m_staticText25, wx.GBPosition( 3, 2 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textHTTT = wx.TextCtrl( self, wx.ID_ANY, u"Cash", wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer5.Add( self.m_textHTTT, wx.GBPosition( 3, 3 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.m_staticText26 = wx.StaticText( self, wx.ID_ANY, u"Staff name:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText27 = wx.StaticText( self, wx.ID_ANY, u"Status:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_btnXoadong = wx.Button( self, wx.ID_ANY, u"Delete line", wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer5.Add( self.m_btnXoadong, wx.GBPosition( 5, 2 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.m_staticText35 = wx.StaticText( self, wx.ID_ANY, u"Select product:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText29 = wx.StaticText( self, wx.ID_ANY, u"Sub total:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText30 = wx.StaticText( self, wx.ID_ANY, u"Tax/Fee:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText31 = wx.StaticText( self, wx.ID_ANY, u"Total:", wx.DefaultPosition, wx.DefaultSize, 0 )
	...
	def m_btnThemOnButtonClick( self, event ):
		...
		if tongdong<=0:
			valid = False
			wx.MessageBox("Product detail is missing","Messages",wx.OK|wx.ICON_WARNING)
			return
	...
	def m_btnXoadongOnButtonClick( self, event ):
		try:
			...
			wx.MessageBox("Please select one to delete: " + e.args[0])
	...
	def InitData(self):
		...
		self.m_gridSource.SetColLabelValue(1, "Product name")
		self.m_gridSource.SetColLabelValue(2, "Unit")
		self.m_gridSource.SetColLabelValue(3, "Amount")
		self.m_gridSource.SetColLabelValue(4, "Price per one")
		self.m_gridSource.SetColLabelValue(5, "Sub total")
		self.m_gridSource.SetColLabelValue(6, "Tax/Fee ratio")
		self.m_gridSource.SetColLabelValue(7, "Tax/Fee")
		self.m_gridSource.SetColLabelValue(8, "Total")
		self.m_gridSource.SetColLabelValue(9, "Note")
		self.m_textbill_date.SetValue(datetime.datetime.now().strftime("%d/%m/%Y"))
		self.m_textsymbol.SetValue("SO")
		self.m_choicestatus.Append('Waiting')
		self.m_choicestatus.Append('Confirm')
		self.m_choicestatus.SetSelection( 0 )
		self.m_choicestaff_name.SetSelection( 0 )
		#Disable
