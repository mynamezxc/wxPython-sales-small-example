...
class UnitPanel ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.m_staticTextMA = wx.StaticText( self, wx.ID_ANY, u"Unit code:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_staticTextTEN = wx.StaticText( self, wx.ID_ANY, u"Unit name:", wx.DefaultPosition, wx.DefaultSize, 0 )
